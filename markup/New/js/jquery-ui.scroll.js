function vertiacalScroll() {
    ...
    if(difference>0)//if the scrollbar is needed, set it up...
    {
        ...
        $("#scroll-pane").after('<div id="scroll-container"><\div id="slider-wrap"><\div id="slider-vertical"><\/div><\/div><div class="slide-up"><\/div><div class="slide-down"><\/div><\/div>');//append the necessary divs so they're only there if needed
        $("#slider-wrap").height($("#scroll-pane").height() - $('.slide-up').height() - $('.slide-down').height());//set the height of the slider bar to that of the scroll pane
	$("#scroll-container").height($("#scroll-pane").height());
    ...
    $('.slide-down').click(function(){
        ...
        sliderVal -= (speed);//increment the current value
